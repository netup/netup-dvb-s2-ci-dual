...
struct stv0900_car_loop_optim {
	...
	UCHAR car_loop_pilots_on_2;
	UCHAR car_loop_pilots_off_2;
	UCHAR car_loop_pilots_on_5;
	UCHAR car_loop_pilots_off_5;
	UCHAR car_loop_pilots_on_10;
	UCHAR car_loop_pilots_off_10;
	UCHAR car_loop_pilots_on_20;
	UCHAR car_loop_pilots_off_20;
	UCHAR car_loop_pilots_on_30;
	UCHAR car_loop_pilots_off_30;

};

struct stv0900_short_frames_car_loop_optim {
	enum fe_stv0900_modulation modulation;
	UCHAR car_loop_cut12_2;    /* Cut 1.2,   SR<=3msps     */
	UCHAR car_loop_cut20_2;    /* Cut 2.0,   SR<3msps      */
	UCHAR car_loop_cut12_5;    /* Cut 1.2,   3<SR<=7msps   */
	UCHAR car_loop_cut20_5;    /* Cut 2.0,   3<SR<=7msps   */
	UCHAR car_loop_cut12_10;   /* Cut 1.2,   7<SR<=15msps  */
	UCHAR car_loop_cut20_10;   /* Cut 2.0,   7<SR<=15msps  */
	UCHAR car_loop_cut12_20;   /* Cut 1.2,   10<SR<=25msps */
	UCHAR car_loop_cut20_20;   /* Cut 2.0,   10<SR<=25msps */
	UCHAR car_loop_cut12_30;   /* Cut 1.2,   25<SR<=45msps */
	UCHAR car_loop_cut20_30;   /* Cut 2.0,   10<SR<=45msps */

};

struct stv0900_short_frames_car_loop_optim_vs_mod {
	enum fe_stv0900_modulation modulation;
	UCHAR car_loop_2;	  /* SR<3msps      */
	UCHAR car_loop_5;	  /* 3<SR<=7msps   */
	UCHAR car_loop_10;   /* 7<SR<=15msps  */
	UCHAR car_loop_20;   /* 10<SR<=25msps */
	UCHAR car_loop_30;   /* 10<SR<=45msps */
};
...
static const USHORT STV0900_InitVal[181][2] = {
	{ R0900_OUTCFG		, 0x00	},
...
static const USHORT STV0900_Cut20_AddOnVal[32][2] = {
